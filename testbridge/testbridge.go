		...
		Subcommands: []*cli.CommandSpec{
			{
				...
				Subcommands: []*cli.CommandSpec{
					{Name: "config-init", Use: "test-bridge config-init", Short: "Write .vscode/test-bridge.json if absent.", Positionals: []cli.PositionalSpec{{Name: "args", Min: 0, Max: 0}}, Handler: handleConfigInit(bridge)},
					{Name: "config-upgrade", Use: "test-bridge config-upgrade", Short: "Upgrade .vscode/test-bridge.json to the current schema.", Positionals: []cli.PositionalSpec{{Name: "args", Min: 0, Max: 0}}, Handler: handleConfigUpgrade(bridge)},
