...
func TestKeelDemoDevHelpJSONCarriesGlobalFlagsAndRoot(t *testing.T) {
...
func TestKeelDemoDevHelpAdvertisesEveryAcceptedGlobalSpelling(t *testing.T) {
...
func captureHelpSurface(t *testing.T, arg string) string {
	t.Helper()
	out, code := captureDemoDevOutput(t, func() int { return run([]string{arg}) })
	if code != 0 {
