...
- **R (Refine)**: Develop additional consistency patterns or identify potential conflict points before saving
...
[R] Refine - Explore additional consistency patterns
...
- Ask the user which patterns they want to develop further
...
After user selects 'C' and content is saved to document, load `./step-07-structure.md` to define the complete project structure.
