...
- Look for existing ./`*architecture*.md`
...
- **STOP here** and load `./step-02-continue.md` immediately
...
✅ Existing workflow detected and handed off to step-02-continue correctly
...
After user selects [C] to continue, only after ensuring all the template output has been created, then load `./step-03-context.md` to analyze the project context and begin architectural decision making.

Remember: Do NOT proceed to step-03 until user explicitly selects [C] from the menu and setup is confirmed!
