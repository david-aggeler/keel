...
# Step 2: Workflow Continuation Handler
...
"Welcome back {user_name}! I found your Architecture work for keel.
...
- Example: If `stepsCompleted: [1, 3, 4]`, load `./step-05-decisions.md`
...
- If confirmed: Delete existing document and read fully and follow: `./step-01-init.md` (fresh start)
