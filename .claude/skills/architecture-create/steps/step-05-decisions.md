...
- **R (Refine)**: Explore innovative approaches to specific decisions before saving
...
[R] Refine - Explore innovative approaches to any specific decisions
...
- Ask the user which decision category they want to explore further
...
After user selects 'C' and content is saved to document, load `./step-06-patterns.md` to define implementation patterns that ensure consistency across AI agents.
