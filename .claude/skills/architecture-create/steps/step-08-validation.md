...
- **R (Refine)**: Address complex architectural issues found during validation before saving
...
[R] Refine - Address any complex architectural concerns
...
- Ask the user which validation concern they want to address further
...
After user selects 'C' and content is saved to document, load `./step-09-complete.md` to complete the workflow and provide implementation guidance.
