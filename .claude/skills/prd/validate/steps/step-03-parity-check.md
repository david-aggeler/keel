...
Analyze non-standard PRD and identify gaps to achieve standard PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring PRD standards expertise and gap analysis
...
- 🎯 Analyze each core PRD section for gaps
...
### 1. Analyze Each Core PRD Section

For each of the 6 core PRD sections, analyze:
...
**Overall Effort to Reach Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core PRD sections. The overall effort to reach the standard structure is: **{effort level}**
...
- All 6 core PRD sections analyzed for gaps
