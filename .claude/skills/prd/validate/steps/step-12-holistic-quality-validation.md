...
nextStepFile: './step-13-completeness-validation.md'
...
Assess the PRD as a cohesive, compelling document — evaluating document flow, dual audience effectiveness (humans and LLMs), PRD principles compliance, and overall quality rating.
...
- ✅ Uses multi-perspective evaluation for holistic quality assessment

### Step-Specific Rules

- 🎯 Focus ONLY on holistic document quality assessment
- 🚫 FORBIDDEN to validate individual components (done in previous steps)
- 💬 Approach: Multi-perspective evaluation for holistic quality
- 🚪 This is a validation sequence step - auto-proceeds when complete

## EXECUTION PROTOCOLS

- 🎯 Perform multi-perspective assessment of document quality
- 🎯 Evaluate document flow, dual audience, and PRD principles
...
### 1. Perform Multi-Perspective Assessment

**Try to use Task tool to spawn a subprocess for multi-perspective evaluation:**
...
**Graceful degradation (if no Task tool available):**
...
- Check PRD principles compliance
...
Without delay, read fully and follow: {nextStepFile} (step-13-completeness-validation.md)
...
- Multi-perspective evaluation performed (or graceful degradation to direct assessment)
- Document flow & coherence assessed
- Dual audience effectiveness evaluated (humans and LLMs)
- PRD principles compliance checked
...
- Missing multi-perspective evaluation
- Missing document flow assessment
- Missing dual audience evaluation
- Not checking all PRD principles
