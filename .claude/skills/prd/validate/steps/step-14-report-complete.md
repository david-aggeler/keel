...
validationStepsCompleted: ['step-01-discovery', 'step-02-format-detection', 'step-03-parity-check', 'step-04-density-validation', 'step-05-brief-coverage-validation', 'step-06-measurability-validation', 'step-07-traceability-validation', 'step-08-implementation-leakage-validation', 'step-09-domain-compliance-validation', 'step-10-project-type-validation', 'step-11-smart-validation', 'step-12-holistic-quality-validation', 'step-13-completeness-validation']
...
- **IF E (Use Edit Workflow):**
  ...
  - If yes: Invoke the `/prd edit` workflow, passing the validation report path as context
...
- **IF X (Exit):**
  ...
  - PRD Validation complete. See `bin/vela-dev help` for the devtool surface, or `/prd`, `/epic`, `/story` for workflow dispatchers.
