...
nextStepFile: './step-05-brief-coverage-validation.md'
...
Validate PRD meets information density standards by scanning for conversational filler, wordy phrases, and redundant expressions that violate conciseness principles.
...
Without delay, read fully and follow: {nextStepFile} (step-05-brief-coverage-validation.md)
