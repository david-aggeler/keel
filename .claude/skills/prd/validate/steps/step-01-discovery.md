...
This file contains the PRD philosophy, standards, and validation criteria that will guide all validation checks. Internalize this understanding — it defines what makes a great PRD.
...
- Search `.` for files matching `*prd*.md`
- Also check for sharded PRDs: `./*prd*/*.md`
...
- "I couldn't find any PRD files in .. Please provide the path to the PRD file you want to validate."
...
Display: **Select an Option:** [R] Refine [C] Continue to Format Detection
