...
nextStepFile: './step-08-implementation-leakage-validation.md'
...
Without delay, read fully and follow: {nextStepFile} (step-08-implementation-leakage-validation.md)
