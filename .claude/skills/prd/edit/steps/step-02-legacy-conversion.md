...
Analyze legacy PRD against standard PRD structure, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring PRD standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against standard PRD structure
...
**For each core PRD section, analyze:**
...
- Manually check PRD for each core section
...
**[R] Restructure** - Full conversion to standard format, then apply your edits
