...
- 🎯 Detect PRD format (standard/legacy)
...
This file defines what makes a great PRD. Internalize this understanding — it will guide improvement recommendations.
...
- **Variant:** 3-4 core sections present, generally follows standard patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow the standard structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is Standard/Variant:**
...
Read fully and follow: `./step-03-review.md`
...
**[C] Convert to Standard Format** - Convert PRD to standard structure, then apply your edits
...
- IF C (Convert): Read fully and follow: `./step-02-legacy-conversion.md`
...
- Standard PRDs proceed directly to review step
