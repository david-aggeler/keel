...
- PRD standards: Load from prd-purpose.md

**Tasks:**

1. Read current PRD section
2. Apply specified changes
3. Ensure PRD principles compliance:
...
- Restructuring: Reformat content to standard structure
...
- Reorganize PRD to standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match the standard format
...
stepsCompleted: ['step-01-discovery', 'step-02-legacy-conversion', 'step-03-review', 'step-04-edit']
...
**[V] Run Validation** - Execute full validation workflow (`/prd validate`)
...
- IF V (Validate): Display "Starting validation workflow..." then follow the `/prd validate` workflow
