...
2. Analyze against PRD standards (from prd-purpose.md)
...
Read fully and follow: `./step-04-edit.md`

### 7. Present MENU OPTIONS (If User Wants Discussion)

**[R] Refine** - Discuss the change plan further
...
- IF R: Discuss with the user, then redisplay menu
