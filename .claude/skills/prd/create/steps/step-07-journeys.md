...
Display: "**Select:** [R] Refine [C] Continue to Domain Requirements (Step 8 of 13)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine; process input and redisplay menu
- IF C: Append the final content to {outputFile}, update frontmatter by adding this step name to the end of the stepsCompleted array, then read fully and follow: ./step-08-domain.md
...
After user selects 'C' and content is saved to document, load `./step-08-domain.md`.
