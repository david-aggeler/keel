...
**Progress: Step 9 of 13** - Next: Project Type Analysis
...
- Project type from step-03 is available for innovation signal matching
...
Display: "**Select:** [R] Refine [C] Continue to Project Type Analysis (Step 10 of 13)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine; process input and redisplay menu
- IF C: Append the final content to {outputFile}, update frontmatter by adding this step name to the end of the stepsCompleted array, then read fully and follow: ./step-10-project-type.md
...
Display: "**Select:** [R] Refine - Let's try to find innovative angles [C] Continue - Skip innovation section and move to Project Type Analysis (Step 7 of 11)"

### Menu Handling Logic

- IF R: Proceed with content generation anyway, then return to menu
...
Skip this step and load `./step-10-project-type.md` if:
...
After user selects 'C' and content is saved to document (or step is skipped), load `./step-10-project-type.md`.

Remember: Do NOT proceed to step-10 until user explicitly selects 'C' from the A/P/C menu (or confirms step skip)!
