...
If the document exists and has frontmatter with `stepsCompleted` BUT `step-15-complete` is NOT in the list, follow the Continuation Protocol since the document is incomplete:

**Continuation Protocol:**

- **STOP immediately** and load `./step-02-continue.md`
- Do not proceed with any initialization tasks
- Let step-02-continue handle all continuation logic
...
- Project Documentation (generally multiple documents might be found for this in the `.` or `docs` folder.)
...
"Welcome {user_name}! I've set up your PRD workspace for keel.
...
- IF C: Update output file frontmatter, adding this step name to the end of the list of stepsCompleted, then read fully and follow: ./step-03-discovery.md
...
ONLY WHEN [C continue option] is selected and [frontmatter properly updated with this step added to stepsCompleted and documentCounts], will you then read fully and follow: `./step-03-discovery.md` to begin project discovery.
...
- Existing workflow detected and properly handed off to step-02-continue
