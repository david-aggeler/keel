...
**Progress: Step 13 of 13** - Next: Polish Document
...
Display: "**Select:** [R] Refine [C] Continue to Polish Document (Step 14 of 15)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine; process input and redisplay menu
- IF C: Append the final content to {outputFile}, update frontmatter by adding this step name to the end of the stepsCompleted array, then read fully and follow: ./step-14-polish.md
...
After user selects 'C' and content is saved to document, load ./step-14-polish.md to finalize the PRD and complete the workflow.
