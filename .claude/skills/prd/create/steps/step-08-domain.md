...
**Progress: Step 8 of 13** - Next: Innovation Focus
...
- 🚫 SKIP if domain complexity is "low" from step-03
...
- Domain classification from step-03 is available
...
**Review classification from step-03:**
...
Display: "**Select:** [R] Refine [C] Continue - Save and Proceed to Innovation (Step 9 of 13)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine; process input and redisplay menu
- IF C: Save content to {outputFile}, update frontmatter, then read fully and follow: ./step-09-innovation.md
...
ONLY WHEN [C continue option] is selected and [content saved or skipped], will you then read fully and follow: `./step-09-innovation.md` to explore innovation.
