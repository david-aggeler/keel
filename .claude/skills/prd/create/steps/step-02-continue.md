...
|---|---|
| step-01-init.md | step-03-discovery.md |
| step-03-discovery.md | step-04-vision.md |
| step-04-vision.md | step-05-executive-summary.md |
| step-05-executive-summary.md | step-06-success.md |
| step-06-success.md | step-07-journeys.md |
| step-07-journeys.md | step-08-domain.md |
| step-08-domain.md | step-09-innovation.md |
| step-09-innovation.md | step-10-project-type.md |
| step-10-project-type.md | step-11-scoping.md |
| step-11-scoping.md | step-12-functional.md |
| step-12-functional.md | step-13-nonfunctional.md |
| step-13-nonfunctional.md | step-14-polish.md |
| step-14-polish.md | step-15-complete.md |
...
- If `stepsCompleted = ["step-01-init.md", "step-03-discovery.md", "step-06-success.md"]`
- Last element is `"step-06-success.md"`
- Table lookup → next step is `./step-07-journeys.md`

### 4. Handle Workflow Completion

**If `stepsCompleted` array contains `"step-15-complete.md"`:**
"Great news! It looks like we've already completed the PRD workflow for keel.
...
"Welcome back {user_name}! I'm resuming our PRD collaboration for keel.
