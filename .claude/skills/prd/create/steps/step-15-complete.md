...
**Option 1: Check Implementation Readiness** (`/prd validate`)
...
PRD complete. See `bin/vela-dev help` for the devtool surface, or `/prd`, `/epic`, `/story` for workflow dispatchers.
...
**Congratulations on completing the Product Requirements Document for keel!** 🎉
