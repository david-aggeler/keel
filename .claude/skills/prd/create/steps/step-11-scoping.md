...
**Progress: Step 11 of 13** - Next: Functional Requirements
...
Display: "**Select:** [R] Refine [C] Continue to Functional Requirements (Step 12 of 13)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine about the scoping; process input and redisplay menu
- IF C: Append the final content to {outputFile}, update frontmatter by adding this step name to the end of the stepsCompleted array (also add `releaseMode: phased` or `releaseMode: single-release` to frontmatter based on user's choice), then read fully and follow: ./step-12-functional.md
...
After user selects 'C' and content is saved to document, load ./step-12-functional.md.
