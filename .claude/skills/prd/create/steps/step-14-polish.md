...
**Progress: Step 14 of 15** - Next: Complete PRD
...
- Read `../data/prd-purpose.md` to understand what makes a great PRD
...
Display: "**Select:** [R] Refine [C] Continue to Complete PRD (Step 15 of 15)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine; process input and redisplay menu
- IF C: Save the polished document to {outputFile}, update frontmatter by adding this step name to the end of the stepsCompleted array, then read fully and follow: ./step-15-complete.md
...
After user selects 'C' and polished document is saved, load `./step-15-complete.md` to complete the workflow.

Remember: Do NOT proceed to step-15 until user explicitly selects 'C' from the A/P/C menu and polished document is saved!
