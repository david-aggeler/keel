...
Display: "**Select:** [R] Refine [C] Continue to Success Criteria (Step 3 of 13)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine; process input and redisplay menu
- IF C: Append the final content to {outputFile}, update frontmatter by adding this step name to the end of the stepsCompleted array, then read fully and follow: ./step-06-success.md
...
ONLY WHEN [C continue option] is selected and [content appended to document], will you then read fully and follow: `./step-06-success.md` to define success criteria.
