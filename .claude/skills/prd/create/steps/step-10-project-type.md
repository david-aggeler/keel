...
**Progress: Step 10 of 13** - Next: Scoping
...
- Project type from step-03 is available for configuration loading
...
- Find row where project_type matches {projectTypeFromStep03}
...
"Based on our conversation and best practices for this product type, I've documented the {project_type}-specific requirements for keel.
...
Display: "**Select:** [R] Refine [C] Continue to Scoping (Step 11 of 13)"

#### Menu Handling Logic

- IF R: Ask the user what they want to refine; process input and redisplay menu
- IF C: Append the final content to {outputFile}, update frontmatter by adding this step name to the end of the stepsCompleted array, then read fully and follow: ./step-11-scoping.md
...
After user selects 'C' and content is saved to document, load `./step-11-scoping.md` to define project scope.

Remember: Do NOT proceed to step-11 (Scoping) until user explicitly selects 'C' from the A/P/C menu and content is saved!
