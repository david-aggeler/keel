...
- Whole: `./*prd*.md`
- Sharded: `./*prd*/index.md` and related files

#### B. Architecture Documents

- Whole: `./*architecture*.md`
- Sharded: `./*architecture*/index.md` and related files

#### C. Epics & Units Documents

- Whole: `./*epic*.md`
- Sharded: `./*epic*/index.md` and related files

#### D. UX Design Documents

- Whole: `./*ux*.md`
- Sharded: `./*ux*/index.md` and related files
